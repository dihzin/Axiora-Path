        ...
        <section className="rounded-[28px] border border-[#CFE6F3] bg-[linear-gradient(140deg,#FFFFFF_0%,#F4FBFF_52%,#EFF8FF_100%)] p-4 shadow-[0_14px_32px_rgba(65,98,151,0.10)]">
          ...
          <div className="mt-3">
            ...
            <div className="h-3 rounded-full bg-[#DCE8F6]">
              <div
                className="h-full rounded-full bg-[linear-gradient(90deg,#1FB7A5_0%,#51D5C3_100%)] transition-transform transition-shadow transition-opacity duration-[180ms]"
        ...
        <div className="grid grid-cols-2 gap-3 sm:grid-cols-3">
          {visibleItems.map((item, index) => {
            ...
            return (
              <article
                key={item.id}
                className={`group relative overflow-hidden rounded-3xl border p-3 shadow-[0_8px_20px_rgba(48,74,117,0.10)] transition-transform transition-shadow transition-opacity duration-200 ${
                  unlocked
