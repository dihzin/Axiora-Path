...
import { getApiErrorMessage, listMemberships, signup } from "@/lib/api/client";
      ...
      <main className="axiora-brand-content safe-px safe-pb mx-auto flex min-h-screen w-full max-w-md overflow-x-clip p-4 md:p-6">
        <div className="relative min-h-[calc(100vh-2rem)] w-full md:min-h-[calc(100vh-3rem)]">
          ...
          <Card className="axiora-glass-card absolute left-1/2 top-[58%] w-full -translate-x-1/2 -translate-y-1/2 text-[#FFF4E7]">
            <CardHeader>
              <CardTitle className="text-[#FFF4E7]">Criar conta</CardTitle>
              <CardDescription className="text-[#E6D8C7]">Cadastre sua família para começar o onboarding no MVP.</CardDescription>
            </CardHeader>
            <CardContent>
              <form className="space-y-3" onSubmit={onSubmit}>
                <label className="block text-xs font-semibold text-[#E6D8C7]" htmlFor="name">Nome</label>
                <Input
                  id="name"
                  ...
                  required
                />
                <label className="block text-xs font-semibold text-[#E6D8C7]" htmlFor="email">Email</label>
                <Input
                  id="email"
                  placeholder="Email"
                  type="email"
                  ...
                  required
                />
                <label className="block text-xs font-semibold text-[#E6D8C7]" htmlFor="password">Senha</label>
                <Input
                  id="password"
                  placeholder="Senha"
                  type="password"
                  ...
                  required
                />
                <label className="block text-xs font-semibold text-[#E6D8C7]" htmlFor="familyName">Nome da família</label>
                <Input
                  id="familyName"
                  ...
                  required
                />
                {error ? <p id="signup-error" role="alert" aria-live="polite" className="text-sm text-rose-300">{error}</p> : null}
