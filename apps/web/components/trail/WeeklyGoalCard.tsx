  ...
  return (
    ...
    >
      ...
      <div className={cn("relative z-10 flex items-center", compact ? "gap-3" : "gap-4")}>
        <div className={cn("flex shrink-0 items-center justify-center rounded-[18px] border border-[#F1C56B]/20 bg-[linear-gradient(145deg,rgba(241,197,107,0.18),rgba(93,188,168,0.12))] shadow-[inset_0_1px_0_rgba(255,255,255,0.08)]", compact ? "h-12 w-12 text-[22px]" : "h-14 w-14 text-[26px]")}>
          ✦
        </div>
