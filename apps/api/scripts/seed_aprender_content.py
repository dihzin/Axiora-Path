...
UNIT_LIBRARY: dict[str, list[UnitBlueprint]] = {
    ...
    "Física": [
        UnitBlueprint("Movimento e Trajetória", "Compreender deslocamento, velocidade e direção em situações do cotidiano.", "Mover com lógica é enxergar padrões do mundo físico."),
        UnitBlueprint("Forças em Ação", "Investigar empurrar, puxar, equilíbrio e atrito em atividades práticas.", "Toda força conta uma história de causa e efeito."),
        UnitBlueprint("Energia e Transformações", "Relacionar energia mecânica, térmica e elétrica em experiências simples.", "Entender energia ajuda você a explicar o que acontece ao redor."),
        UnitBlueprint("Ondas e Som", "Explorar propagação do som, frequência e intensidade em contextos reais.", "Ouvir e medir ondas transforma curiosidade em ciência."),
        UnitBlueprint("Luz e Visão", "Analisar reflexão, refração e formação de imagens no dia a dia.", "A luz revela como observamos e interpretamos o mundo."),
        UnitBlueprint("Eletricidade Básica", "Reconhecer circuitos, condutores e segurança elétrica.", "Com cuidado e método, eletricidade vira conhecimento aplicado."),
        UnitBlueprint("Calor e Temperatura", "Diferenciar temperatura, calor e mudanças térmicas em materiais.", "Medir e comparar melhora decisões em qualquer experimento."),
        UnitBlueprint("Física no Esporte", "Aplicar conceitos de força e movimento em jogos e atividades físicas.", "Ciência e movimento juntos deixam tudo mais divertido."),
        UnitBlueprint("Projeto Experimental", "Planejar e executar investigação com hipótese, teste e conclusão.", "Seu raciocínio científico está ficando cada vez mais sólido."),
    ],
    "Química": [
        UnitBlueprint("Matéria e Propriedades", "Identificar estados físicos e propriedades observáveis da matéria.", "Observar com atenção é o primeiro passo do químico."),
        UnitBlueprint("Misturas no Cotidiano", "Classificar misturas homogêneas e heterogêneas com exemplos reais.", "Separar e comparar torna a química mais clara."),
        UnitBlueprint("Transformações Químicas", "Reconhecer indícios de reação e mudanças de substâncias.", "Cada reação mostra como a matéria se reorganiza."),
        UnitBlueprint("Ácidos e Bases", "Explorar noções iniciais de pH e segurança em experiências simples.", "Com responsabilidade, você aprende química com confiança."),
        UnitBlueprint("Tabela Periódica Inicial", "Ler padrões de elementos e famílias químicas essenciais.", "Encontrar padrões facilita entender conteúdos avançados."),
        UnitBlueprint("Soluções e Concentração", "Relacionar solvente, soluto e concentração em situações práticas.", "Dosar corretamente é uma habilidade poderosa."),
        UnitBlueprint("Química e Ambiente", "Analisar impacto de resíduos e escolhas sustentáveis.", "Química também é cuidar do planeta."),
        UnitBlueprint("Química dos Alimentos", "Investigar conservação, nutrientes e transformações culinárias.", "Na cozinha também acontece muita ciência."),
        UnitBlueprint("Projeto Químico", "Construir missão final com observação, registro e conclusão.", "Você já pensa como pesquisador em mini laboratório."),
    ],
    "História": [
        UnitBlueprint("Tempo Histórico", "Organizar fatos em linha do tempo e compreender permanências e mudanças.", "Entender o tempo ajuda a interpretar o presente."),
        UnitBlueprint("Povos Antigos", "Conhecer civilizações antigas e suas contribuições culturais.", "As origens da sociedade explicam muitos hábitos atuais."),
        UnitBlueprint("Brasil Colonial", "Analisar formação social, economia e culturas no período colonial.", "Conhecer o passado fortalece pensamento crítico."),
        UnitBlueprint("Independência e Império", "Compreender transições políticas e sociais do Brasil imperial.", "História é feita de decisões e consequências."),
        UnitBlueprint("República e Cidadania", "Relacionar direitos, deveres e participação social ao longo do tempo.", "Cidadania se constrói com informação e ação."),
        UnitBlueprint("Mundo Contemporâneo", "Investigar eventos marcantes dos séculos XX e XXI.", "Conectar passado e presente amplia sua visão de mundo."),
        UnitBlueprint("Culturas e Identidades", "Valorizar diversidade cultural, memória e patrimônio.", "Respeitar diferenças também é aprender história."),
        UnitBlueprint("Fontes Históricas", "Interpretar documentos, imagens e relatos com criticidade.", "Boa análise começa com fontes confiáveis."),
        UnitBlueprint("Projeto de Memória", "Produzir narrativa histórica conectando fatos e contexto.", "Seu olhar histórico está mais maduro e consistente."),
    ],
    "Geografia": [
        UnitBlueprint("Espaço e Território", "Compreender noções de localização, território e paisagem.", "Ler o espaço é entender como vivemos nele."),
        UnitBlueprint("Mapas e Escalas", "Interpretar mapas, coordenadas e escalas em desafios práticos.", "Mapa é linguagem de quem explora o mundo."),
        UnitBlueprint("Clima e Tempo", "Diferenciar tempo atmosférico, clima e fatores climáticos.", "Observar o clima ajuda a planejar melhor o dia a dia."),
        UnitBlueprint("Relevo e Recursos Naturais", "Relacionar formas de relevo e uso sustentável dos recursos.", "Cuidar da natureza começa com conhecimento."),
        UnitBlueprint("População e Urbanização", "Analisar distribuição populacional e dinâmica das cidades.", "Entender cidades é entender relações humanas."),
        UnitBlueprint("Geografia do Brasil", "Explorar regiões brasileiras, culturas e atividades econômicas.", "Conhecer o Brasil fortalece identidade e cidadania."),
        UnitBlueprint("Globalização", "Investigar conexões econômicas, culturais e tecnológicas no mundo.", "O mundo conectado exige leitura crítica."),
        UnitBlueprint("Riscos Ambientais", "Reconhecer impactos ambientais e estratégias de mitigação.", "Prevenir é sempre melhor do que remediar."),
        UnitBlueprint("Projeto de Território", "Criar proposta local com análise geográfica aplicada.", "Seu pensamento espacial está pronto para novos desafios."),
    ],
    "Inglês": [
